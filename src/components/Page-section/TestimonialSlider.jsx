...
export default function TestimonialSlider() {
    ...
    const sliderDatas = [
        { img: 'src/assets/person-1.jpg', description: 'Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer convallis volutpat dui quis scelerisque.', author: 'Maria Jones', position: 'CEO, Co-Founder, XYZ Inc.' },
        { img: 'src/assets/person-1.jpg', description: 'Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer convallis volutpat dui quis scelerisque.', author: 'Maria Jones', position: 'CEO, Co-Founder, XYZ Inc.' },
        { img: 'src/assets/person-1.jpg', description: 'Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer convallis volutpat dui quis scelerisque.', author: 'Maria Jones', position: 'CEO, Co-Founder, XYZ Inc.' },
    ];
    const settings = {
